  ...
  return (
    <button
      ...
      className={cn(
        ...
        checked ? "bg-zinc-950 dark:bg-zinc-50" : "bg-zinc-200 dark:bg-zinc-800",
        className
      )}
      {...props}
    >
      <span
        className={cn(
          "pointer-events-none block h-4 w-4 rounded-full bg-white dark:bg-zinc-950 shadow-sm ring-0 transition-transform duration-200",
