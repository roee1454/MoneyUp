      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-hide">
        {configuredProviders.map((p) => (
          <button
            ...
            className={cn(
              'flex items-center gap-2 px-2.5 py-1.5 border transition-all cursor-pointer select-none',
              activeProvider === p
          ...
          >
            <AiIcon
              ...
              size="sm"
              className={cn(
                'h-4 w-4 grayscale opacity-70 transition-all',
                activeProvider === p && 'grayscale-0 opacity-100 scale-110',
              )}
            />
